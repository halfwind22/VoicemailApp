        ...
        tts = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (status == TextToSpeech.SUCCESS) {
                    ...
                    speak("Say first to access first sent message,second for second message and so on.Say back to go back to options page");
        ...
        if (requestCode == 100) {
            if (resultCode == RESULT_OK && null != data) {
               ...
               // DatabaseHelper db = new DatabaseHelper(this);
                ...
                DatabaseHelper db = new DatabaseHelper(this);
                tcount = db.countSent(to1);
                System.out.println("Sent Count    :  " + tcount);
                ...
                if (result.get(0).equals("cancel")) {
                    ...
                    if (tcount >= 1) {
                        ...
                        speak("First message from sent list :\n From : " + to.getText().toString() + "\nDate : " + sdat.getText().toString() + "\nSubject : " + subje.getText().toString() + "\nContent : " + conten.getText().toString());
                    }
                    else
                    {
                        speak("NO MESSAGE EXISTS");
                        Intent intent = new Intent(Sent.this, Sent.class);
                    ...
                    if (tcount >= 2) {
                        ...
                        speak("Second message from sent list :\n From : " + to.getText().toString() + "\nDate : " + sdat.getText().toString() + "\nSubject : " + subje.getText().toString() + "\nContent : " + conten.getText().toString());
                    }
                    else
                    {
                        speak("NO MESSAGE EXISTS");
                   ...
                   /* String fr1 = fro.getText().toString().trim();
                    ...
                    String co1 = conten.getText().toString().trim(); */
                        ...
                        speak("Third message from sent list :\n From : " + to.getText().toString() + "\nDate : " + sdat.getText().toString() + "\nSubject : " + subje.getText().toString() + "\nContent : " + conten.getText().toString());
                    }
                    else
                    {
                        speak("NO MESSAGE EXISTS");
                    ...
                    if (tcount >= 4) {
                        ...
                        speak("Fourth message from sent list :\n From : " + to.getText().toString() + "\nDate : " + sdat.getText().toString() + "\nSubject : " + subje.getText().toString() + "\nContent : " + conten.getText().toString());
                    }
                    else
                    {
                        speak("NO MESSAGE EXISTS");
                    ...
                    if (tcount >= 5) {
                        ...
                        speak("Fifth message from sent list :\n From : " + to.getText().toString() + "\nDate : " + sdat.getText().toString() + "\nSubject : " + subje.getText().toString() + "\nContent : " + conten.getText().toString());
                    }
                    else
                    {
                        speak("NO MESSAGE EXISTS");
                    ...
                    Intent intent = new Intent(Sent.this, Options.class);
                    startActivity(intent);
                }
