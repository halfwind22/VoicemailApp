...
public class Trash1 extends AppCompatActivity {
        ...
        tts = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (status == TextToSpeech.SUCCESS) {
                    ...
                    speak("Say first to access first trash message,second for second message and so on.Say back to go back to options page");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 100) {
            if (resultCode == RESULT_OK && null != data) {
                ...
                tcount = db.countTrash(to1);
                System.out.println("Trash Count    :  " + tcount);
                ...
                if (result.get(0).equals("cancel")) {
                    ...
                    if (tcount >= 1) {
                        ...
                        speak("First message from trash list :\n To : " + to.getText().toString() + "\nDate : " + sdat.getText().toString() + "\nSubject : " + subje.getText().toString() + "\nContent : " + conten.getText().toString());
                    }
                    else
                    {
                        speak("NO MESSAGE IN TRASH");
                        Intent intent = new Intent(Trash1.this, Trash1.class);
                    ...
                    if (tcount >= 2) {
                        ...
                        speak("Second message from trash list :\n To : " + to.getText().toString() + "\nDate : " + sdat.getText().toString() + "\nSubject : " + subje.getText().toString() + "\nContent : " + conten.getText().toString());
                    }
                    else
                    {
                   ...
                   /*String fr1 = fro.getText().toString().trim();
                    ...
                    if (tcount >=3) {
                        ...
                        speak("Third message from trash list :\n To : " + to.getText().toString() + "\nDate : " + sdat.getText().toString() + "\nSubject : " + subje.getText().toString() + "\nContent : " + conten.getText().toString());
                    }
                    else
                    {
                        speak("NO MESSAGE EXISTS");
                    ...
                    if (tcount >=4) {
                        ...
                        speak("Fourth message from trash list :\n To : " + to.getText().toString() + "\nDate : " + sdat.getText().toString() + "\nSubject : " + subje.getText().toString() + "\nContent : " + conten.getText().toString());
                    }
                    else
                    {
                        speak("NO MESSAGE EXISTS");
                    ...
                    if (tcount >= 5) {
                        ...
                        System.out.println("FROM 5   :  " + str[0]);
                        System.out.println("DATE  5   :  " + str[1]);
                        System.out.println("SUBJECT 5  :  " + str[2]);
                        System.out.println("CONTENT 5 :  " + str[3]);

                        to.setText(str[0]);
                        sdat.setText(str[1]);
                        subje.setText(str[2]);
                        conten.setText(str[3]);
                        speak("Fifth message from trash list :\n To : " + to.getText().toString() + "\nDate : " + sdat.getText().toString() + "\nSubject : " + subje.getText().toString() + "\nContent : " + conten.getText().toString());
                    }
                    else
                    {
                        speak("NO MESSAGE EXISTS");
                    ...
                    Intent intent = new Intent(Trash1.this, Options.class);
                    startActivity(intent);
                }

                else if (result.get(0).equals("delete") || result.get(0).equals("Delete")) {
                    Intent intent = new Intent(Trash1.this, Delete.class);
                    startActivity(intent);
                }
                else if (result.get(0).equals("restore") || result.get(0).equals("Restore")) {
                    Intent intent = new Intent(Trash1.this, Restore.class);
                    startActivity(intent);
                }
