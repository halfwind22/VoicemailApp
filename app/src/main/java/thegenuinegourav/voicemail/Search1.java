...
public class Search1 extends AppCompatActivity {
    ...
    public static String fsearch = Search.fro;
    String to1 = t_id;
    public int tcount;
        ...
        tts = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (status == TextToSpeech.SUCCESS) {
                    ...
                    speak("Say first to access first search message,second for second message and so on.Say back to go to options page");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 100) {
            if (resultCode == RESULT_OK && null != data) {
                ...
                tcount = db.countSearch(fsearch,to1);
                System.out.println("Search Count    :  " + tcount);
                ...
                if (result.get(0).equals("cancel")) {
                    ...
                    if (tcount >= 1) {
                        ...
                        msg = db1.searchList(fsearch, to1);
                    ...
                    if (tcount >= 2) {
                        ...
                        speak("Second message from search list :\n To : " + to.getText().toString() + "\nDate : " + sdat.getText().toString() + "\nSubject : " + subje.getText().toString() + "\nContent : " + conten.getText().toString());
                    }
                    else
                    {
                        speak("NO MESSAGE EXISTS");
                    ...
                    if (tcount >= 3) {
                        ...
                        speak("Third message from search list :\n To : " + to.getText().toString() + "\nDate : " + sdat.getText().toString() + "\nSubject : " + subje.getText().toString() + "\nContent : " + conten.getText().toString());
                    }
                    else
                    {
                        speak("NO MESSAGE EXISTS");
                    ...
                    if (tcount >= 4) {
                        ...
                        speak("Fourth message from search list :\n To : " + to.getText().toString() + "\nDate : " + sdat.getText().toString() + "\nSubject : " + subje.getText().toString() + "\nContent : " + conten.getText().toString());
                    }
                    else
                    {
                        speak("NO MESSAGE EXISTS");
                    ...
                    if (tcount >= 5) {
                        ...
                        speak("Fifth message from search list :\n To : " + to.getText().toString() + "\nDate : " + sdat.getText().toString() + "\nSubject : " + subje.getText().toString() + "\nContent : " + conten.getText().toString());
                    }
                    else
                    {
                        speak("NO MESSAGE EXISTS");
                    ...
                    Intent intent = new Intent(Search1.this, Options.class);
                    startActivity(intent);
                }
