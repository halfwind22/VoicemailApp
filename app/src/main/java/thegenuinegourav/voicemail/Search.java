        ...
        tts = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (status == TextToSpeech.SUCCESS) {
                    ...
                    speak("Say from address of the mailer whose message you want to search");
                ...
                if(result.get(0).equals("cancel"))
                {
                    ...
                    switch (noc) {
                        case 1:
                            ...
                            f = f + "@gmail.com";
                            ft.setText(f);
                            speak("Please Confirm the search from id \n User id : "+ ft.getText().toString() + "\nSpeak Yes to confirm or no to reenter");
                       ...
                       /* case 2:
                        ...
                        case 2:
                            ...
                            {   String to1 = Config.EMAIL;
                                fsearch = ft.getText().toString().trim();
                                fro= fsearch;
                                //String strash = st.getText().toString().trim();
                                System.out.println("S_MAIL_FROM    :  " +fsearch);
                                System.out.println("S_MAIL_TO    :  " +to1);

                                Intent intent = new Intent(Search.this, Search1.class);
