        ...
        tts = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (status == TextToSpeech.SUCCESS) {
                    ...
                    speak("Say from address of the mailer whose message you want to restore");
                    ...
                    switch (noc) {
                        ...
                        case 3:
                            if(result.get(0).equals("yes"))
                            {
                                ...
                                db1.restoreMail(ftrash,strash);
                                speak("Message Restored");
                                Intent intent = new Intent(Restore.this, Options.class);
                                startActivity(intent);
                            }
                            else if(result.get(0).equals("no")) {
                                Intent intent = new Intent(Restore.this, Restore.class);
                                startActivity(intent);
                            }
                            else
                            {
